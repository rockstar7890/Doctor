...
//       } else {
//         toast.error("Failed to get PayPal approval link.");
//       }
//     } catch (error) {
//       console.log(error);
//       toast.error(error.message);
...
//                       className="text-[#696969] sm:min-w-48 py-2 border rounded hover:bg-gray-100 hover:text-white transition-all duration-300 flex items-center justify-center"
//                     >
//                       <img className="max-w-20 max-h-5" src={assets.logo} alt="PayPal" />
//                     </button>
//                   </>
//                 )}
  ...
  const handleViewReceipt = async (appointmentId) => {
    ...
    try {
      const response = await axios.post(
        `${backendUrl}/api/user/get-receipt`,
            ...
            <div className="flex flex-col gap-2 justify-end text-sm text-center">
              ...
              {!item.cancelled && item.payment && !item.isCompleted && (
                <div className="flex flex-col gap-2 sm:min-w-48">
                  <button className="py-2 border rounded text-[#696969] bg-[#EAEFFF] cursor-default">
                    Paid
                  </button>
                  <button
                    onClick={() => handleViewReceipt(item._id)}
                    className="py-2 border rounded text-blue-500 hover:bg-blue-50"
                  >
                    Download Invoice
                  </button>
                </div>
